    ...
    <div className="bg-white p-8 shadow-lg rounded-2xl border border-gray-100">
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Join Ferixo for exclusive offers
        </p>
      </div>
        ...
        <div>
          ...
          <div className="mt-1 flex gap-2">
            ...
            <select
              id="countryCode"
              name="countryCode"
              className="block w-24 px-3 py-3 border border-gray-300 rounded-lg shadow-sm bg-white text-gray-900 focus:outline-none focus:ring-[#0A1A2F] focus:border-[#0A1A2F] sm:text-sm transition-colors"
            >
      ...
      <div className="mt-6">
        ...
        <div className="mt-6">
          <button
            type="button"
            className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 shadow-sm text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none transition-colors"
          >
            {/* Google Icon SVG */}
